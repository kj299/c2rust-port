...
| `harnesses/library-differential/lib_diff.py` | C-ABI library differential: call a C `.so` and Rust `cdylib` per-function, compare return + output buffers, crash/timeout-isolated | CI |
