...
Why this exists (RETROSPECTIVE-kit-audit.md §6 item 2): `skeleton/THREAT-MODEL.md`
...
Fail-closed (LESSONS #6): a missing file, an unreadable file, or an empty one is a
